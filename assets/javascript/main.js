      ...
      init: function () {
        ...
        for (var i = 0; i < swiper.slides.length; i++) {
          $(swiper.slides[i])
            .find(".bg-img")
            .attr({
              "data-swiper-parallax": 0.1 * swiper.width,
            });
        }
      },
      resize: function () {
...
$(document).ready(function () {
  ...
  $(".nav-item.dropdown").hover(
    function () {
      ...
      $(this).find(".dropdown-menu").stop(true, true).fadeIn(200); // Show the dropdown
    },
    function () {
      var dropdown = $(this).find(".dropdown-menu");
      timeout = setTimeout(function () {
        dropdown.stop(true, true).fadeOut(200); // Hide the dropdown after a delay
